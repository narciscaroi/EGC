...
void Laborator3::Init()
{
	...
	Mesh* square5 = Object2D::CreateSquare("square5", corner, squareSide, glm::vec3(0.11f, 0.56f, 1));
	AddMeshToList(square5);
	Mesh* square6 = Object2D::CreateSquare("square6", corner, squareSide, glm::vec3(1, 1, 1));
...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	modelMatrix *= Transform2D::Translate(translateX/2, translateY/3);
	...
	modelMatrix *= Transform2D::Translate(20 * translateX, -20 * translateY);
	modelMatrix *= Transform2D::Rotate(-rotation);
	modelMatrix *= Transform2D::Translate(-translateX, -translateY);
	...
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(300, 550);
	modelMatrix *= Transform2D::Rotate(-rotation/2);
	modelMatrix *= Transform2D::Translate(-latura / 2, -latura/2);
	RenderMesh2D(meshes["square3"], shaders["VertexColor"], modelMatrix);

	//bonus
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(800, 350);
	modelMatrix *= Transform2D::Rotate(-rotation / 10);
	modelMatrix *= Transform2D::Translate(-latura / 2, -latura / 2);
	RenderMesh2D(meshes["square4"], shaders["VertexColor"], modelMatrix);

	int c = 120;
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(970, 500);
	modelMatrix *= Transform2D::Rotate(rotation / 10);
	modelMatrix *= Transform2D::Translate(c * translateX, c * translateY);
	modelMatrix *= Transform2D::Rotate(-rotation/10);
	modelMatrix *= Transform2D::Translate(-c * translateX, -c * translateY);
	...
	int c3 = 170;
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(1000, 530);
	modelMatrix *= Transform2D::Rotate(rotation / 10);
	modelMatrix *= Transform2D::Translate(c2 * translateX, c2 * translateY);
	modelMatrix *= Transform2D::Rotate(-rotation / 10);
	modelMatrix *= Transform2D::Translate(-c2 * translateX, -c2 * translateY);
	modelMatrix *= Transform2D::Scale(0.1f, 0.1f);
	modelMatrix *= Transform2D::Rotate(rotation/2);
	modelMatrix *= Transform2D::Translate((c2+c3) * translateX, (c2 + c3) * translateY);
	//modelMatrix *= Transform2D::Rotate(-rotation/2);
	//modelMatrix *= Transform2D::Translate(-(c2 + c3) * translateX, -(c2 + c3) * translateY);
