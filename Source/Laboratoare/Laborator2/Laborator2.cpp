...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		{
			VertexFormat(glm::vec3(-4, 0,  0), glm::vec3(0.8f, 0.5f, 0.4f)), //0
			VertexFormat(glm::vec3(0, 0, -4),glm::vec3(0.8f, 0.5f, 0.6f)), //1
			VertexFormat(glm::vec3(-1, 4, 0),glm::vec3(0.8f, 0.5f, 0.1f)), //3

			VertexFormat(glm::vec3(0, 0, -4),glm::vec3(0.4f, 0.4f, 0.4f)), //1
			VertexFormat(glm::vec3(2, 0, 2),glm::vec3(0.4f, 0.4f, 0.4f)), //2
			VertexFormat(glm::vec3(-1, 4, 0),glm::vec3(0.4f, 0.4f, 0.4f)), //3

			VertexFormat(glm::vec3(-4, 0,  0), glm::vec3(0.25f, 0.5f, 0.3f)), //0
			VertexFormat(glm::vec3(0, 0, -4),glm::vec3(0.2f, 0.5f, 0.3f)), //1
			VertexFormat(glm::vec3(2, 0, 2),glm::vec3(0.2f, 0.5f, 0.3f)), //2

			VertexFormat(glm::vec3(-4, 0,  0), glm::vec3(0.7, 0.4f, 0.4f)), //0
			VertexFormat(glm::vec3(2, 0, 2),glm::vec3(0.7f, 0.4f, 0.4f)), //2
			VertexFormat(glm::vec3(-1, 4, 0),glm::vec3(0.7f, 0.4f, 0.4f)), //3
		};
		...
		{
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0.7f, 0.5f)),
			VertexFormat(glm::vec3(3, 0, 0), glm::vec3(0.2f, 0.3f, 0.3f)),
			VertexFormat(glm::vec3(3, 0, 3), glm::vec3(0.15f, 0.8f, 0.4f)),
			VertexFormat(glm::vec3(0, 0, 3), glm::vec3(1.2f, 0.3f, 0.1f)),
		...
		meshes["patrat"] = new Mesh("patrat din 2 triunghiuri");
		meshes["patrat"]->InitFromData(vertices3, indices3);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.25f));
	RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(0.5f, 0.5f, 0), glm::vec3(0.25f));
	RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(-2, 1, -1), glm::vec3(0.50f));
