	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				glm::vec4 newVect = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1.0);
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				// Use glm::rotate()
				glm::vec4 newVect = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1.0);
				forward = glm::normalize(glm::vec3(newVect));
				newVect = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1.0);
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				// Don't forget to normalize the vectors
				glm::vec4 newVect = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 1.0);
				right = glm::normalize(glm::vec3(newVect));
				up = glm::normalize(glm::cross(right, forward));
			}
